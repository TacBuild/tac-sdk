...
describe('OrbsOpener4 Integration Tests', () => {
    ...
    beforeAll(async () => {
        opener = await OrbsOpener4.create(Network.MAINNET);
    }, 30000);
    ...
    describe('create', () => {
        it('should create OrbsOpener4 instance for testnet', async () => {
            const instance = await OrbsOpener4.create(Network.TESTNET);
            expect(instance).toBeInstanceOf(OrbsOpener4);
        }, 30000);

        it('should create OrbsOpener4 instance for mainnet', async () => {
            const instance = await OrbsOpener4.create(Network.MAINNET);
            expect(instance).toBeInstanceOf(OrbsOpener4);
        }, 30000);

        it('should create OrbsOpener4 with custom timeout', async () => {
            const instance = await OrbsOpener4.create(Network.MAINNET, 20000);
            expect(instance).toBeInstanceOf(OrbsOpener4);
        }, 30000);
    });
